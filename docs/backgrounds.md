...
Of course, <b>Generation</b> isn't exactly bound by these rules. While Kindred of higher generations are generally younger and vice versa, that doesn't always have to be the case. You would, however, still have to explain why a couple centuries old 7th gen vampire would embrace a 20-something in the modern nights.

<div class="yourAttentionPlease">

<b>Important</b>
* Territory cannot be taken at character creation
* Influence has a 2 dot maximum entirely.
* Status has a 2 dot minimum during character creation.
* Tzimisce Antitirbu are restricted to a Retainer maximum of 2 dots entirely.
* Anything else above 3 dots will require approval from the Storyteller or an Assistant
* Havens are included under resources, not domain
* Domain is territory officially recognized by the Baron of that location, which is unlikely to be had at character creation.

</div>

<div class="secondHeader" id="allies">Allies</div>
...
<em>Allies must be listed on a character sheet with their name and relation to the character.</em>
...
<div class="secondHeader" id="alternate-identity">Alternate Identity</div>
...
<em>This must be justified within the character's backstory and be roleplayed at the appropriate dot level.</em>
...
<div class="secondHeader" id="contacts">Contacts</div>
...
<em>Contacts must be listed on a character sheet with their name and relation to the character, as well as fleshed out in the character's backstory as to why they're a contact in the first place.</em>
...
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Five major contacts

<div class="secondHeader" id="domain">Domain</div>
...
<em>Domain is a piece of territory officially granted by the Baron of that location. A PC is unlikely to have this at character creation.</em>
...
<div class="secondHeader" id="fame">Fame</div>
...
<em>Remember that fame is a double edged sword, and is easily something that could shatter the Masquerade if high enough.</em>
...
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> You’re a household word. People name their children after you.

<div class="secondHeader" id="generation">Generation</div>
...
<div class="secondHeader" id="herd">Herd</div>
...
<em>The nature of their herd must align with a character's traits. A anti-social character is unlikely to have a herd made of clubgoers.</em>

<i class="fas fa-circle fa-sm"></i> Three vessels <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Seven vessels <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> 15 vessels <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> 30 vessels <br>
...
<div class="secondHeader" id="influence">Influence</div>
...
<em>While a single dot of influence can be attributed to family prestige, further dots will requie the character to have earned it themselves.</em>
...
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Vastly influential; a factor in global politics

<div class="secondHeader" id="mentor">Mentor</div>
...
<em>How they acquired a mentor, who the mentor is, and their relationship must be detailed within the character's backstory. As with other personal NPCs, mentors will not be played by Storytellers.</em>

<i class="fas fa-circle fa-sm"></i> Mentor is an ancilla of little influence, or a Ductus or Pack Priest. <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Mentor is respected: an elder or highly-decorated veteran, for instance. <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Mentor is heavily influential, such as a member of the Primogen or a Bishop. <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Mentor has a great deal of power over the city: a Prince or Archbishop, for example. <br>
...
<div class="secondHeader" id="resources">Resources</div>
...
<em>Resouces 1 is sufficient to have a haven that at least puts a roof over your head. Keep in mind that resources also includes incoming cash <b>and</b> non-liquid assets.</em>

<i class="fas fa-circle fa-sm"></i> Sufficient. You can maintain a typical residence in the style of the working class with stability, even if spending sprees come seldom. (Working dollar-to-dollar, lower-class) <br>
...
<div class="secondHeader" id="retainers">Retainers</div>
...
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Three retainers <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Four retainers <br>
...
<div class="secondHeader" id="status">Status</div>
...
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Influential: an elder/Templar <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Powerful: a member of the Primogen/ a Bishop <br>
...
<div class="secondHeader" id="status-anarch">Status (Anarch)</div>
With the dust settling after the third revolt, the Movement's numbers have skyrocketed. Either by actions done before, during the recent revolt, or last night your name got around to the local Anarch crowd. Of course, retaining such prestige isn't easy. Ever since you joined the rebellion, you've been contributing to the sect in some way, otherwise the next up-an-coming Lick will take your place in the limelight.

Caitiff are not restricted from taking Status among the Anarchs. Additionally, you can only have Status with one sect at a time, unless a certain concept (such as an infiltrator with Alternate Identity) can explain why you haven't had a stake rammed through your chest yet.

<i class="fas fa-circle fa-sm"></i> Known: You’ve started making a name for yourself. You might be a rising tough working for a gang or this week’s darling hacker, fighting for the cause behind a computer screen. <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Respected: You’ve become known for being able to hold your own on the streets and in the backrooms where the real decisions are being made. <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Influential: Anarchs listen to your opinion. You might have led a minor skirmish or exposed some shitbag Ivory Tower lick in a scheme to put more money in his pockets. Perhaps you’re the author of a well-received Anarch manifesto, or you call the shots for a respected crew. Whatever the case, there are few in the domain or across a Free State territory who don’t know about you. <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> Powerful: You have a great deal of influence over your city. You might be a leader of a powerful known crew or one of the few Anarch elders. <br>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i>  Luminary: You are the acknowledged leader of your Anarch domain, or well-placed among them. You might be the Baron (or a backer behind a figurehead Baron).

<div class="secondHeader" id="territory">Territory</div>
Territory is a custom background exclusive to LA in Anarchy to offer players the chance of political mobility. Each dot comes with set requirements, perks, and hindrances as you work to stake your claim in the Free State. While the main function of territory is for Anarchy gangs, it’s entirely possible for Camarilla members and those independent of sect to try and carve out their own spot of land as well, even if it’s considerably more dangerous to do so. Territory cannot be taken at character creation.

Kindred followers are other PCs that have decided to support your cause. These characters must be active, and not belong to the same player. These characters must also not be owned by the player trying to earn Territory dots. Characters can only support one Kindred's Territory at a time, however that doesn't mean they are inherently hostile to all others (they just aren't actively working for them.) This also means that characters supporting another cannot try to earn their own Territory dots.

Claim successes dictate how effectively you're claiming and holding your Territory. You and your followers can roll this once every night, with occasional scenes posted to prove the group is actively working to establish their domain. While the attribute/ability depends on how the characters are going about taking the location, the difficulty is always 7.

Later dots require that you have earned additional backgrounds. These dots must be had before rolling for any further claim.

At Territory 2+, opposing Gang/Sect members trying to settle in the same location as another group can use their growth rolls to instead remove successes from their rival. This must be declared before the roll is made so failure/botches can be handled accordingly.

Territory 4 and 5 are not available for play at this time.

Click the different dot levels for more information.

<details>
<summary>
<i class="fas fa-circle fa-sm"></i> <b>Start up:</b> You got enough of a start to give yourself an actual title and name your claim. It might not be much, but it’s yours.
</summary>
...
* A title (Ex: Baron)
* 2 dots of Communal Haven from Anarchs Unbound to spread between Luxury, Size, and Security
* 1 dot of Domain under ‘Territory’
* 1 dot of Anarch Status

<b>Hindrances/Dangers:</b>

* Taking out the trash once in a while to keep the place yours
* Potentially (likely) being a laughing stock when bringing your new 'authority' up

</details>

<details>
<summary>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> <b>Established Roots:</b> Maybe you're being taken seriously now, maybe not. Either way, you can't deny the progress you've made. Things are beginning to shape-up.
</summary>
...
* An additional 2 dots of Communal Haven from Anarchs Unbound to spread between Luxury, Size, and Security <b>OR</b> 1 additional dot of Domain under ‘Territory.’ (Reflecting either focusing on the upkeep of personal quarters or obtaining more territory.)
* An additional 1 dot of Anarch Status
* Slightly more authority within your Territory
* 1 dot of Anarch Status

<b>Hindrances/Dangers:</b>

* Someone isn’t a fan of you and yours. Enemy at 2 points gained against you specifically and at 1 point against your supporters for association.
* Beginning environmental problems (Kine if in a public space, Lupines if near the outskirts/wilderness, random Kindred entering your turf, etc.)
* Potential consequences from hunting botches (Hunters swarming the area, Masquerade breaches, etc.)

</details>

<details>
<summary>
<i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i><i class="fas fa-circle fa-sm"></i> <b>Firm Foundation:</b> Many Kindred in the area know your name, for better or for worse.
</summary>
...
* An additional 2 dots of Communal Haven from Anarchs Unbound to spread between Luxury, Size, and Security <b>OR</b> 1 additional dot of Domain under ‘Territory.’ (Reflecting either focusing on the upkeep of personal quarters or obtaining more territory.)
* An additional 1 dot of Anarch Status
* Definite authority within your claimed Territory
* 1 major contact that you’ve gotten to know through your elevated position
* The ability to grant Domain within your Territory

<b>Hindrances/Dangers:</b>

* Regular environmental problems (Kine if in a public space, Lupines if near the outskirts/wilderness, random Kindred entering your turf, etc.)
* Chosen social flaw at 3 points or greater
* Likely consequences from hunting botches (Hunters swarming the area, Masquerade breaches, etc.)
