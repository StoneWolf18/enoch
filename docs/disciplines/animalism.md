...
<div class="leftHeader" id="•"><span style="color: #a0467b;">•</span> Feral Whispers</div>
...
<div class="leftHeader" id="••"><span style="color: #a0467b;">••</span> Beckoning</div>
...
<div class="leftHeader" id="•••"><span style="color: #a0467b;">•••</span> Quell the Beast</div>
...
<div class="leftHeader" id="••••"><span style="color: #a0467b;">••••</span> Subsume the Spirit</div>
...
<div class="leftHeader" id="•••••"><span style="color: #a0467b;">•••••</span> Drawing Out the Beast</div>
...
1 success — The character transfers the Beast, but unleashes it upon a random individual.<br>
2 successes — The character is stunned by the effort and may not act next turn, but transfers the Beast successfully. <br> Alternatively, the character may act normally during the turn, but must spend a Willpower point or suffer a single level of lethal damage.<br>
