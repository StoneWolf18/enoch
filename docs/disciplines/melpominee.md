...
<div class="leftHeader" id="•"><span style="color: #a0467b;">•</span> The Missing Voice</div>
...
<div class="leftHeader" id="••"><span style="color: #a0467b;">••</span> Phantom Speaker</div>
...
<div class="secondHeader">System</div>
The player rolls Wits + Performance (difficulty 7) and spends a blood point. Each success allows one turn of speech; three or more successes allow speech for an entire scene.

<div class="leftHeader" id="•••"><span style="color: #a0467b;">•••</span> Madrigal</div>
...
<div class="leftHeader" id="••••"><span style="color: #a0467b;">••••</span> Siren’s Beckoning</div>
...
<div class="secondHeader">System</div>
The Daughter may use Phantom Speaker or Siren’s Beckoning on a number of targets equal to her Stamina + Performance. The player must spend one blood point for every five targets beyond the first.
